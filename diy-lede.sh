...
sed -i 's/KERNEL_PATCHVER:=4.14/g' ./target/linux/ramips/Makefile  #修改内核版本
sed -i 's/KERNEL_TESTING_PATCHVER:=4.14/g' ./target/linux/ramips/Makefile  #修改内核版本
...
git clone https://github.com/jefferymvp/luci-app-koolproxyR package/luci-app-koolproxyR  #KPR
